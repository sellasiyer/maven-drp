...
/**
 * JUnit test for {@link CTYouSectionPage}.
 */
public class CTYouSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(CTYouSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(CTYouSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
	...
	tester.startPage(CTYouSectionPage.class, new PageParameters());

	// Check that the right page was rendered (no unexpected redirect or
	// intercept)
	tester.assertRenderedPage(CTYouSectionPage.class);
