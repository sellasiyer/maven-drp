...
/**
 * JUnit test for {@link MobileSpecialistInfoSectionPage}.
 */
public class MobileSpecialistInfoSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MobileSpecialistInfoSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MobileSpecialistInfoSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
