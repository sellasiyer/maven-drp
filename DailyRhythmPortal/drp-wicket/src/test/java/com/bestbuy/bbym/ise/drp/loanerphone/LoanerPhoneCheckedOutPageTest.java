...
/**
 * JUnit test for {@link LoanerPhoneCheckedOutPage}.
 */
public class LoanerPhoneCheckedOutPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(LoanerPhoneCheckedOutPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(LoanerPhoneCheckedOutPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
