...
/**
 * JUnit test for {@link PCServicesAddOptionsPage}.
 */
public class PCServicesAddOptionsPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(PCServicesAddOptionsPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(PCServicesAddOptionsPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER);
    }
	...
	tester.startPage(PCServicesAddOptionsPage.class, new PageParameters());

	// Check that the right page was rendered (no unexpected redirect or
	// intercept)
	tester.assertRenderedPage(PCServicesAddOptionsPage.class);
