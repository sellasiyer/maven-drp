 ...
 * generated in the com.bestbuy.bbym.ise.iseclientacdsparam package. 
...
public class ObjectFactory {
    ...
    private final static QName _ParamRequest_QNAME = new QName("http://bestbuy.com/bbym/logistics/param/service/v1", "ParamRequest");
    ...
    private final static QName _ParamGroup_QNAME = new QName("http://bestbuy.com/bbym/logistics/param/fields/v1", "ParamGroup");
    ...
    private final static QName _ParamResponse_QNAME = new QName("http://bestbuy.com/bbym/logistics/param/service/v1", "ParamResponse");
    ...
    private final static QName _GroupRequest_QNAME = new QName("http://bestbuy.com/bbym/logistics/param/fields/v1", "GroupRequest");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bestbuy.bbym.ise.iseclientacdsparam
     * 
     */
    ...
    /**
     * Create an instance of {@link ParamGroupRequest }
     * 
     */
    public ParamGroupRequest createParamGroupRequest() {
        return new ParamGroupRequest();
    }
    ...
    /**
     * Create an instance of {@link ParamResponseType }
     * 
     */
    public ParamResponseType createParamResponseType() {
        return new ParamResponseType();
    }
    ...
    /**
     * Create an instance of {@link ParamRequestType }
     * 
     */
    public ParamRequestType createParamRequestType() {
        return new ParamRequestType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ParamRequestType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/param/service/v1", name = "ParamRequest")
    public JAXBElement<ParamRequestType> createParamRequest(ParamRequestType value) {
        return new JAXBElement<ParamRequestType>(_ParamRequest_QNAME, ParamRequestType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/param/fields/v1", name = "ParamGroup")
    public JAXBElement<Group> createParamGroup(Group value) {
        return new JAXBElement<Group>(_ParamGroup_QNAME, Group.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ParamResponseType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/param/service/v1", name = "ParamResponse")
    public JAXBElement<ParamResponseType> createParamResponse(ParamResponseType value) {
        return new JAXBElement<ParamResponseType>(_ParamResponse_QNAME, ParamResponseType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ParamGroupRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/param/fields/v1", name = "GroupRequest")
    public JAXBElement<ParamGroupRequest> createGroupRequest(ParamGroupRequest value) {
        return new JAXBElement<ParamGroupRequest>(_GroupRequest_QNAME, ParamGroupRequest.class, null, value);
    }
