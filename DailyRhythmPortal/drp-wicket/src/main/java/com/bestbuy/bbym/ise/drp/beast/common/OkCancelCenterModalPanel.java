...
public abstract class OkCancelCenterModalPanel extends ModalPanel {

    private static final long serialVersionUID = 1L;

    private boolean okSelected = false;

    public OkCancelCenterModalPanel(String id, final String okLabel, final String cancelLabel) {
	super(id);
	setVisible(false);
