...
/**
 * JUnit test for {@link PrintAgreementPage}.
 */
public class PrintAgreementPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(PrintAgreementPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(PrintAgreementPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
