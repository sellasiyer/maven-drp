...
/**
 * JUnit test for {@link ViewManageAppointmentPage}.
 */
public class ViewManageAppointmentPageTest extends BaseWebPageTest {
	...
	assertAccessAllowed(ViewManageAppointmentPage.class, DrpConstants.DRP_BEAST);
	assertAccessDenied(ViewManageAppointmentPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
