...
/**
 * JUnit test for {@link MobileInternetSectionPage}.
 */
public class MobileInternetSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MobileInternetSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MobileInternetSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
