...
public class DigitalRecSheetPage extends BaseWebPage {

    private static Logger logger = LoggerFactory.getLogger(DigitalRecSheetPage.class);
    ...
    private Form<DigitalRecSheetPage> form = new Form<DigitalRecSheetPage>("digitalRecSheetForm");
    private Form<DigitalRecSheetPage> closeForm = new Form<DigitalRecSheetPage>("closeForm");
    ...
    public DigitalRecSheetPage(Recommendation recommendation, final MobileSalesWorkspacePage mswPage) {
