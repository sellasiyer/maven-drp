...
/**
 * JUnit test for {@link MobileWOWSectionPage}.
 */
public class MobileWOWSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MobileWOWSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MobileWOWSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
	...
	tester.startPage(MobileWOWSectionPage.class, new PageParameters());

	// Check that the right page was rendered (no unexpected redirect or
	// intercept)
	tester.assertRenderedPage(MobileWOWSectionPage.class);
