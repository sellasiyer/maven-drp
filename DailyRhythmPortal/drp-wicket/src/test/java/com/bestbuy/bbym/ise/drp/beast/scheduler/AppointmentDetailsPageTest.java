...
/**
 * JUnit test for {@link AppointmentDetailsPage}.
 */
public class AppointmentDetailsPageTest extends BaseWebPageTest {
	...
	assertAccessAllowed(AppointmentDetailsPage.class, DrpConstants.DRP_BEAST);
	assertAccessDenied(AppointmentDetailsPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
