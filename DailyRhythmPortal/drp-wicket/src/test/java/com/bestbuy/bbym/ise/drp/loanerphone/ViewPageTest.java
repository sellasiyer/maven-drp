...
/**
 * JUnit test for {@link ViewPage}.
 */
public class ViewPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(ViewPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER, DrpConstants.DRP_LEAD,
		DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(ViewPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER, DrpConstants.SHP_MANAGER);
    }
