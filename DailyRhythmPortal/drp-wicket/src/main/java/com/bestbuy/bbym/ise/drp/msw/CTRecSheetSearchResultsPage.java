...
public class CTRecSheetSearchResultsPage extends NewBaseNavPage {

    private static Logger logger = LoggerFactory.getLogger(CTRecSheetSearchResultsPage.class);
    ...
    private final CTRecSheetPage mswPage;
    private SortableRecSheetDataProvider searchResultsDataProvider;
    private final CTRecSheetSearchPanel searchPanel;
    private String storeLabel;
    private Recommendation recSheet;

    public CTRecSheetSearchResultsPage(final PageParameters parameters, CTRecSheetPage ctRecSheetPage,
	    SortableRecSheetDataProvider searchResultsDataProvider, CTRecSheetSearchPanel ctRecSheetSearchPanel) {

	super(parameters);
	this.mswPage = ctRecSheetPage;
	this.searchResultsDataProvider = searchResultsDataProvider;
	this.searchPanel = ctRecSheetSearchPanel;
	...
	AjaxLink<Object> createNewRecSheet = new AjaxLink<Object>("createNewRecSheetLink") {
		...
		setResponsePage(new CTDigitalRecSheetPage(recSheet, CTRecSheetSearchResultsPage.this.mswPage));
	    }
	};
	...
	AjaxLink<Object> newSearchLink = new AjaxLink<Object>("newSearchLink") {
		...
		setResponsePage(CTRecSheetPage.class);
	...
	add(new AbstractDefaultAjaxBehavior() {
	    ...
	    private static final long serialVersionUID = 7721520205466091943L;
	...
	public ActionPanel(String id, IModel<Recommendation> model) {
		...
		public void onClick() {
		    ...
		    CTYouSectionPage page = new CTYouSectionPage(getPageParameters());
