...
public class TransactionBaseType {
    ...
    @XmlElement(name = "ID", namespace = "http://www.tsh.bestbuy.com/common/v1", required = true)
    ...
    /**
     * Define Beast Transaction ID, Carrier Transaction ID
     * 
     * @return
     *     possible object is
     *     {@link IdentifierType }
    ...
    /**
     * Define name of the transaction whether Beast Transaction ID or Carrier Transaction ID
     * 
     * @return
     *     possible object is
     *     {@link NameType }
