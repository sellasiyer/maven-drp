...
/**
 * JUnit test for {@link MobileYouSectionPage}.
 */
public class MobileYouSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MobileYouSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MobileYouSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
	...
	tester.startPage(MobileYouSectionPage.class, new PageParameters());

	// Check that the right page was rendered (no unexpected redirect or
	// intercept)
	tester.assertRenderedPage(MobileYouSectionPage.class);
