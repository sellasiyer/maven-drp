...
/**
 * JUnit test for {@link CTRecommendationsSectionPage}.
 */
public class CTRecommendationsSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(CTRecommendationsSectionPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(CTRecommendationsSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
