...
/**
 * JUnit test for {@link AppointmentConfirmationPage}.
 */
public class AppointmentConfirmationPageTest extends BaseWebPageTest {
	...
	assertAccessAllowed(AppointmentConfirmationPage.class, DrpConstants.DRP_BEAST);
	assertAccessDenied(AppointmentConfirmationPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
