...
/**
 * JUnit test for {@link MobileOurRecommendationsSectionPage}.
 */
public class MobileOurRecommendationsSectionPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MobileOurRecommendationsSectionPage.class, DrpConstants.DRP_ADMIN,
		DrpConstants.DRP_MANAGER, DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MobileOurRecommendationsSectionPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
