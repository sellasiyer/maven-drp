...
/**
 * JUnit test for {@link DigitalRecSheetSearchResultsPage}.
 */
public class DigitalRecSheetSearchResultsPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(DigitalRecSheetSearchResultsPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(DigitalRecSheetSearchResultsPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
