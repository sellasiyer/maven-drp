...
/**
 * JUnit test for {@link LoanerPhoneLandingPage}.
 */
public class LoanerPhoneLandingPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(LoanerPhoneLandingPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(LoanerPhoneLandingPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
