 ...
 * generated in the com.bestbuy.bbym.ise.iseclientacdsdevice package. 
...
public class ObjectFactory {
    ...
    private final static QName _SearchForDevicesRequest_QNAME = new QName("http://bestbuy.com/bbym/logistics/device/service/v1", "SearchForDevicesRequest");
    ...
    private final static QName _SearchForDevicesResponse_QNAME = new QName("http://bestbuy.com/bbym/logistics/device/service/v1", "SearchForDevicesResponse");
    private final static QName _Title_QNAME = new QName("http://www.tsh.bestbuy.com/common/v1", "Title");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bestbuy.bbym.ise.iseclientacdsdevice
     * 
     */
    ...
    /**
     * Create an instance of {@link SearchForDevicesRequestType }
     * 
     */
    public SearchForDevicesRequestType createSearchForDevicesRequestType() {
        return new SearchForDevicesRequestType();
    }
    ...
    /**
     * Create an instance of {@link SearchForDevicesResponseType }
     * 
     */
    public SearchForDevicesResponseType createSearchForDevicesResponseType() {
        return new SearchForDevicesResponseType();
    }
    ...
    /**
     * Create an instance of {@link DeviceSearchType }
     * 
     */
    public DeviceSearchType createDeviceSearchType() {
        return new DeviceSearchType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SearchForDevicesRequestType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/device/service/v1", name = "SearchForDevicesRequest")
    public JAXBElement<SearchForDevicesRequestType> createSearchForDevicesRequest(SearchForDevicesRequestType value) {
        return new JAXBElement<SearchForDevicesRequestType>(_SearchForDevicesRequest_QNAME, SearchForDevicesRequestType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SearchForDevicesResponseType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://bestbuy.com/bbym/logistics/device/service/v1", name = "SearchForDevicesResponse")
    public JAXBElement<SearchForDevicesResponseType> createSearchForDevicesResponse(SearchForDevicesResponseType value) {
        return new JAXBElement<SearchForDevicesResponseType>(_SearchForDevicesResponse_QNAME, SearchForDevicesResponseType.class, null, value);
    }
