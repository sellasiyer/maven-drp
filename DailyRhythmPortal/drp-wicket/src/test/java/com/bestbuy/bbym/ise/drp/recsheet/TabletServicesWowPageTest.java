...
/**
 * JUnit test for {@link TabletServicesWowPage}.
 */
public class TabletServicesWowPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(TabletServicesWowPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(TabletServicesWowPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
