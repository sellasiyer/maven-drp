...
/**
 * JUnit test for {@link MACServicesWowPage}.
 */
public class MACServicesWowPageTest extends BaseNavPageTest {
	...
	assertAccessAllowed(MACServicesWowPage.class, DrpConstants.DRP_ADMIN, DrpConstants.DRP_MANAGER,
		DrpConstants.DRP_LEAD, DrpConstants.DRP_USER, DrpConstants.DRP_TEAM);
	assertAccessDenied(MACServicesWowPage.class, DrpConstants.DRP_BEAST, DrpConstants.SHP_USER,
